...
public class KurtiPageControllerFaila {
	/**
	 * @param LenteleBeDuomenu klasės sąrašo tipo kintamasis duomenų bazės lentelių duomenims
	 */
	private ArrayList<LenteleBeDuomenu> lenteles;
	/**
	 * @param LenteleBeDuomenu klasės sąrašo tipo kintamasis paieškos lentelių duomenims
	 */
	private ArrayList<LenteleBeDuomenu> paieskos_lenteles;
	/**
	 * @param LenteleBeDuomenu klasės sąrašo tipo kintamasis ataskaitos lentelių duomenims
	 */
	...
	public ArrayList<String> javaFailui() {
		...
		for( int i=0; i < lenteles.size(); i++ ) {
			...
			java_failui.add("	/**");
			java_failui.add("	* @param " + lenteles.get(i).getLenteles_pav() + "_rep " + StringUtils.capitalize(lenteles.get(i).getLenteles_pav()) + "Repository klasės tipo kintamasis");
			java_failui.add("	*/");
